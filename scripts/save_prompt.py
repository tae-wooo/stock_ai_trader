...
def main():
    ...
    stock_code = input("프롬프트를 저장할 종목코드 입력: ").strip()
    ...
    output_path = output_dir / f"{today}_{target_stock.code}_{safe_name}_prompt.txt"
    ...
    print()
    print("이제 이 파일을 열어서 전체 복사한 뒤, ChatGPT와 Gemini에 각각 붙여넣으면 됩니다.")
